...
**Lives mais relevantes pra Google Ads**:
- L315 — Como criar campanha do zero (Lógica do bolo de cenoura fofinho)
- L323 — Segmentação no Google Ads (10 formas, segmentos personalizados, palavras-chave negativas)
- L361 — Performance Max + IA das fontes de tráfego
- L365 — Google Ads 2026 (10 passos, 4 quadrantes, Discovery pra YouTube)
- L367 — 7 formas de segmentar (cruza com Google)
- L374 — Estratégia pra negócio local (Pmax pra visitas presenciais)

Pra recomendação acionável, sempre **citar a fonte** ("Pela Live 315, a lógica do bolo de cenoura fofinho exige que a palavra-chave pesquisada apareça no anúncio E na LP. Aqui detectei desalinhamento entre..."). Se o cenário não tem cobertura, dizer explicitamente.
