              ...
              >
                ...
                >
                  ...
                  <div style={{ minWidth: 0, flex: 1 }}>
                    ...
                    >
                      {/* QUEM ESTA ATENDENDO: a recepcao bate o olho e sabe se
                          a conversa esta com a IA ou com uma pessoa. */}
                      <span
                        title={
                          c.humano
                        ...
                        style={{
                          background: c.humano ? "rgba(202,138,4,0.14)" : "rgba(37,99,235,0.12)",
                          color: c.humano ? "#a16207" : "var(--accent)",
                          border: `1px solid ${c.humano ? "rgba(202,138,4,0.35)" : "rgba(37,99,235,0.3)"}`,
                          borderRadius: 20,
                          fontSize: 10.5,
                          fontWeight: 800,
                          padding: "2px 8px",
